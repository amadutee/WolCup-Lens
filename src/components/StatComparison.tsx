...
export function StatComparison({ homeStats, awayStats }: { homeStats?: TeamStats; awayStats?: TeamStats }) {
  if (!homeStats || !awayStats) {
    return <p className="rounded-2xl border border-dashed border-white/15 p-5 text-slate-400">Team stats will populate here when provider data is connected.</p>;
  }
